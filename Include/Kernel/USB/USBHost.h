...
#endif // PADOS_OPT_DEBUG_USB_DIAGNOSTICS
    bool            SubmitURB(USB_PipeIndex pipeIndex, USB_RequestDirection direction, USB_TransferType enpointType, USBH_InitialTransactionPID initialPID, void* buffer, size_t length, USB_TransactionCallback&& callback);
