...
void QSPI_STM32::Write32(uint32_t data)
{
    QUADSPI->DR = data;
}
...
uint32_t QSPI_STM32::Read32() const
{
    return QUADSPI->DR;
}
...
void QSPI_STM32::WaitFIFOThreshold() const
{
    while ((QUADSPI->SR & (QUADSPI_SR_FTF | QUADSPI_SR_TCF)) == 0) {}
}
...
void QSPI_STM32::WaitTransferComplete() const
{
